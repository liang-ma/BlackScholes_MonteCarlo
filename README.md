...
The convergence of the result produced by the Monte Carlo method is ensured essentially by running a very large number of simulations. $C=MN$ is usually a very large number, e.g. $10^9$. 
